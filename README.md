...
![Schematic of the circuit](circuit_schematic.png "Schematic of the circuit"){ width=50% }
...
![Illustration of the circuit](circuit_illustration.png "Illustration of the circuit"){ width=50% }